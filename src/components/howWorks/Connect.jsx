...
const Connect = () => {
  ...
  const stats = [
    {
      ...
      icon: <FaUserFriends style={{ fontSize: 40, color: '#7c2d12' }} />,
      color: '#f8f9fa',
    ...
    },
    {
      ...
      icon: <FaCalendarWeek style={{ fontSize: 40, color: '#7c2d12' }} />,
      color: '#f8f9fa',
      textColor: '#00bcd4',
    ...
    },
    {
      ...
      icon: <FaCalendarAlt style={{ fontSize: 40, color: '#7c2d12' }} />,
      color: '#f8f9fa',
      textColor: '#ff5a5f',
  ...
  return (
    <>
      ...
      <Container sx={{ textAlign: 'center', marginTop: { xs: 0, md: 5 }, fontFamily: "Outfit", mb: 5 }}>
        <Typography variant="h4" sx={{
          marginBottom: 4, color: '#7c2d12', fontFamily: "Outfit sans-serif",
        ...
        <Grid container spacing={4} justifyContent="center">
          {features.map((feature) => (
            <Grid item xs={12} sm={4} key={feature.id}>
              ...
              <Box sx={{ marginTop: 2 }}>
                <Typography variant="h6" sx={{ color: '#7c2d12', fontFamily: "Outfit sans-serif" }}>
                  {feature.title}
                </Typography>
